...
if (isset ($_GET['step']) && $_GET['step'] == 'czat')
{
    ...
    if ($_POST['czat'] == 'odblok')
    {
        ...
        $db -> Execute('INSERT INTO `log` (`owner`, `log`, `czas`) VALUES('.$_POST['czat_id'].', \'<b><a href="view.php?view="'.$player -> id.'">'.$player -> user.'</a></b>, ID <b>'.$player -> id.'</b> '.UNBLOCK_BY.'\', '.$strDate.')') or die($db -> ErrorMsg());
